...
const DefaultIdleTimeout = 300000000 * time.Second

// DefaultHandshakeIdleTimeout is the default idle timeout used before handshake completion.
const DefaultHandshakeIdleTimeout = 300000000 * time.Second
...
const RetiredConnectionIDDeleteTimeout = 5000000000 * time.Second
